...
from CMGTools.WTau3Mu.analyzers.qcdGenMatcherAnalyzer               import qcdGenMatcherAnalyzer
...
from CMGTools.WTau3Mu.samples.mc_QCD_MuEnriched_2018 import QCD_MuEnriched as qcd_samples
...
for sample in samples:
    ...
    sample.splitFactor     = int(1.35 * len(sample.files) / 2.) #splitFactor(sample, 1e5)
...
tau3MuAna = cfg.Analyzer(
    ...
    spectators  = ['HLT_DoubleMu3_Trk_Tau3mu', 'HLT_Tau3Mu_Mu7_Mu1_TkMu1_IsoTau15', 'HLT_Tau3Mu_Mu5_Mu1_TkMu1_IsoTau10_Charge1'],
...
qcdGenMatchAna = cfg.Analyzer(
    qcdGenMatcherAnalyzer,
    name='qcdGenMatcherAnalyzer',
    getter = lambda event : event.tau3mu,
