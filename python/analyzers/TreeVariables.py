...
event_vars = [
    ...
    Variable('is_data'                    , lambda ev : ev.input.eventAuxiliary().isRealData()                                              , type=int, storageType='B'),
...
electron_vars = [
    ...
    Variable('reliso05', lambda lep : lep.relIso(iso_type='dbeta', cone_size=0.3, dbeta_factor=0.5, all_charged=0)),
    Variable('reliso05_04', lambda lep : lep.relIso(iso_type='dbeta', cone_size=0.4, dbeta_factor=0.5, all_charged=0)),
    Variable('reliso05_04', lambda lep : lep.relIso(iso_type='dbeta', cone_size=0.4, dbeta_factor=0.5, all_charged=0)),
...
# muon
muon_vars = [
    Variable('reliso05'         , lambda muon : muon.relIso(iso_type='dbeta', cone_size=0.4, dbeta_factor=0.5, all_charged=0)),
    Variable('reliso05_03'      , lambda muon : muon.relIso(iso_type='dbeta', cone_size=0.3, dbeta_factor=0.5, all_charged=0)),
